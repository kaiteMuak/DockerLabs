...
## Paso N2: Investigando la página
Explorando un poco, por el apartado visual, llegaremos a ```http://172.17.0.2/imagenes/README.txt``` el cual nos dice que hay una contraseña: ```password1```
